        ...
        <div className="flex-1 space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">İşletme performans metrikleri</p>
                </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Stok Kartı</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Kayıtlı Cari</p>
                    </CardContent>
                </Card>
            </div>
                    ...
                    <CardContent>
                        <div className="space-y-8">
                            {recentSales.map((sale) => (
                                <div key={sale.id} className="flex items-center">
                                    <Avatar className="h-9 w-9">
                                        <AvatarImage src={`https://api.dicebear.com/7.x/initials/svg?seed=${sale.name}`} alt="Avatar" />
                            ...
                            {recentSales.length === 0 && (
                                <p className="text-muted-foreground text-sm text-center py-4">Henüz satış kaydı yok.</p>
                            )}
                        </div>
                    </CardContent>
                </Card>
